package com.android.deepbookkeeping.llm_inference
...
enum class Model(
    ...
    GEMMA3_1B_IT_CPU(
        path = "/data/local/tmp/llm/Gemma3-1B-IT_multi-prefill-seq_q8_ekv2048.task",
    ...
    GEMMA_2_2B_IT_CPU(
        path = "/data/local/tmp/llm/Gemma2-2B-IT_multi-prefill-seq_q8_ekv1280.task",
    ...
    LLAMA_3_2_1B_INSTRUCT(
        path = "/data/local/tmp/llm/Llama-3.2-1B-Instruct_multi-prefill-seq_q8_ekv1280.task",
    ...
    LLAMA_3_2_3B_INSTRUCT(
        path = "/data/local/tmp/llm/Llama-3.2-3B-Instruct_multi-prefill-seq_q8_ekv1280.task",
    ...
    QWEN2_0_5B_INSTRUCT(
        path = "/data/local/tmp/llm/Qwen2.5-0.5B-Instruct_multi-prefill-seq_q8_ekv1280.task",
    ...
    QWEN2_1_5B_INSTRUCT(
        path = "/data/local/tmp/llm/Qwen2.5-1.5B-Instruct_multi-prefill-seq_q8_ekv1280.task",
    ...
    QWEN2_5_3B_INSTRUCT(
        path = "/data/local/tmp/llm/Qwen2.5-3B-Instruct_multi-prefill-seq_q8_ekv1280.task",
    ...
    SMOLLM_135M_INSTRUCT(
        path = "/data/local/tmp/llm/SmolLM-135M-Instruct_multi-prefill-seq_q8_ekv1280.task",
